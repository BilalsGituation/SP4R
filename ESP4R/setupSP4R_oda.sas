...
%macro unpack(unzip /* Full path pointing to where to create the ESP4R data */
...
%let url=%str(http://dl.liveweb.sas.com/eldata/sp4r_oda.zip);
...
%unpack(%superq(path),esp4r.zip,esp4r)

/* added to set &path for elearning */
%let path=/home/&sysuserid/ESP4R;
